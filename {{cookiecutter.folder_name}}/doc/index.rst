.. _camera-{{cookiecutter.lowercase_projectname}}:

{{cookiecutter.project_name}}
--------

.. image:: {{cookiecutter.lowercase_projectname}}.jpg

Introduction
````````````

This is the official Lima camera {{cookiecutter.lowercase_projectname}}. It has been made to help you getting started with Lima and to test/play Lima without any hardware.

Prerequisite
````````````

There is no special prerequisite, the {{cookiecutter.lowercase_projectname}} plugin can be compiled and tested on both Linux and Windows platforms.
...
.. code-block:: sh
  ...
  -DLIMACAMERA_{{cookiecutter.uppercase_projectname}}=true
...
.. cpp:namespace-push:: lima::{{cookiecutter.lowercase_projectname}}
